      ...
      <section className="container">
        ...
        <div className="about">
          ...
          <div className="hero-content" id="aboutP">
            <p>
              This platform is designed to help users connect with Bundeli Gayak,
              ...
              and there is also an opportunity for individuals to register as Bundeli Gayak.
              The platform includes detailed information about scheduled Bundeli performances,
